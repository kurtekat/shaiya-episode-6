...
/// </summary>
void hook_0x47B8FB(CUser* user, DBCharacterList_EP6_4* dbCharacter)
{
...
/// </summary>
void hook_0x47B3E7(CUser* user, DBAgentCharNameAvailableOutgoing* incoming)
{
    GameCharNameAvailableOutgoing outgoing{};
